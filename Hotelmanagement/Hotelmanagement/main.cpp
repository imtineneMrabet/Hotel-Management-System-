...
int main()
{
	int Qrooms = 0, Qpasta = 0, Qburger = 0, Qnoodles = 0, Qshake = 0, Qchicken = 0;/* total rooms at the beginning */

	int Srooms = 0, Spasta = 0, Sburger = 0, Snoodles = 0, Sshake = 0, Schicken = 0;/*served rooms */
...
p:
	...
	goto p; /* jump statement: after making the choice, pass the control to p menu */
}
